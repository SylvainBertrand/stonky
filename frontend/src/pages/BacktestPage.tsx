...
export function BacktestPage() {
  const { result, sweepResult, selectedSweepIndex, setSelectedSweepIndex } = useBacktestStore();
  ...
  const displayResult =
    selectedSweepIndex !== null && sweepResult ? sweepResult.results[selectedSweepIndex] : result;
            ...
            {displayResult ? (
              ...
              <div className="rounded-lg border border-gray-800 bg-gray-900/50 p-8 text-center">
                <div className="text-gray-500">
                  ...
                  <p className="text-sm">
                    Configure a strategy and click &quot;Run Backtest&quot; to see results here
                  </p>
                </div>
              </div>
            )}
