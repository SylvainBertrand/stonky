    ...
    <div className="space-y-4">
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-gray-800">
              <th
                className="text-left px-3 py-2 font-semibold text-gray-400 cursor-pointer hover:text-gray-200"
              ...
              <th
                className="text-right px-3 py-2 font-semibold text-gray-400 cursor-pointer hover:text-gray-200"
      ...
      <div className="flex items-center justify-between text-xs text-gray-400">
        <div>
          {trades.length > 0 && (
            <span>
              Showing {currentPage * TRADES_PER_PAGE + 1}-
              {Math.min((currentPage + 1) * TRADES_PER_PAGE, trades.length)} of {trades.length}{' '}
              trades
            </span>
          )}
        </div>
